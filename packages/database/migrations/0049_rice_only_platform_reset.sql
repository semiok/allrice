...
-- MET-93 product reset: the platform employee catalog starts with Rice only.
-- Re-run the proven dependency cleanup because older application builds could
-- recreate the retired built-in employees after migration 0047 completed.

-- Retire every historical DSH-native Skill and employee binding. The new
-- platform Skill registry intentionally starts empty.
delete from allrice_employee_dsh_skill_bindings;
delete from allrice_dsh_skills;
delete from allrice_platform_dsh_skills;

insert into allrice_runtime_metadata (key, value)
values (
  'employee-catalog-baseline',
  '{"version":"0049","employees":["Rice"],"skills":[],"migrationMode":"platform-reset"}'::jsonb
)
